...
The course material for our Mastering Threads Course on 2020-10-26
is available from a private git repository:

  URL: https://www.javaspecialists.eu/git/safari/masteringthreads-5514.git
  Username: safari5514
  Password: iBvOmGZh
...
3. Clone the repository:
   ...
   3.3. You can also clone from the command line by downloading git from
        ...
        Then issue this command in a terminal or command prompt:
          ...
          git clone https://www.javaspecialists.eu/git/safari/masteringthreads-5514.git
          Username: safari5514
          Password: iBvOmGZh
...
5. If the project does not compile, add JUnit4 to the build by adding the
   contents of the lib directory to the project as Libraries.
